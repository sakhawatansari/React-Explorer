    ...
    return (
        <>
            <ul className="list-none">
                {todos.map((todo) => (
                    <li
                        className="mt-4 flex justify-between items-center bg-zinc-800 px-4 py-2 rounded border border-x-yellow-200"
                        key={todo.id}
                    >
                        {editId === todo.id ? (
                            <input
                        ...
                        <div className="flex">
                            ...
                            <button
                                ...
                                className="text-white bg-red-500 border-0 py-1 px-4 focus:outline-none hover:bg-red-600 rounded text-md ml-4" // Added margin here
                            >
                                <svg
